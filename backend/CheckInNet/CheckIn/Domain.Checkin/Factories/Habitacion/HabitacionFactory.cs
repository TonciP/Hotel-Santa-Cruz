...
namespace Domain.Estadia.Factories
{
    public class HabitacionFactory : IHabitacionFactory
    {
        ...
        public Habitacion CrearHabitacion(Guid? habitacionId, string codigoHabitacion, string limitePersona, int tipoHabitacion, double precioHabitacion, int numeroHabitacion, string caracteristicasHabitacion, string disponibilidad)
        {
